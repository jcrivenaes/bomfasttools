...
var options = {
  title: {
    text: "Total reisetid Bergen-Stavanger",
    align: "center",
    style: {
      fontSize: "30px",
    },
  ...
  subtitle: {
    text: [
      "Ved fysisk reise er dagens fly er desidert mest effektivt, også etter Hordfast.",
      "Reisetider for buss/bil er hvis Rogfast+Hordfast er bygget.",
    ],
    align: "center",
    offsetY: 60,
    style: {
